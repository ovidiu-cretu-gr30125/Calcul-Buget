...
namespace Calcul_Buget
{
    public partial class Form7 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'db_calculbugetDataSet8.venituri_extraordinare_view' table. You can move, or remove it, as needed.
            this.venituri_extraordinare_viewTableAdapter.Fill(this.db_calculbugetDataSet8.venituri_extraordinare_view);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("select sum(Suma+TVA) from venituri_extraordinare;", SqlConn))
                {
                    SqlConn.Open();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConn.Open();
                SqlDataAdapter v1 = new SqlDataAdapter("venituri_extraordinare_insert", SqlConn);
