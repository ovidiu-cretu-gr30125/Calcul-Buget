...
namespace Calcul_Buget
{
    public partial class Form5 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'db_calculbugetDataSet6.venituri_exploatare_view' table. You can move, or remove it, as needed.
            this.venituri_exploatare_viewTableAdapter.Fill(this.db_calculbugetDataSet6.venituri_exploatare_view);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("select sum(Suma+TVA) from venituri_exploatare;", SqlConn))
                {
                    SqlConn.Open();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConn.Open();
                SqlDataAdapter v1 = new SqlDataAdapter("venituri_exploatare_insert", SqlConn);
