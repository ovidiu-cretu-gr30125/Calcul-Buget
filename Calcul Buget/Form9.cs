...
namespace Calcul_Buget
{
    public partial class Form9 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'db_calculbugetDataSet10.cheltuieli_financiare_view' table. You can move, or remove it, as needed.
            this.cheltuieli_financiare_viewTableAdapter.Fill(this.db_calculbugetDataSet10.cheltuieli_financiare_view);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("select sum(Suma+TVA) from cheltuieli_financiare;", SqlConn))
                {
                    SqlConn.Open();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConn.Open();
                SqlDataAdapter v1 = new SqlDataAdapter("cheltuieli_financiare_insert", SqlConn);
