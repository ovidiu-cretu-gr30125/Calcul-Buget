...
namespace Calcul_Buget
{
    public partial class Form10 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'db_calculbugetDataSet11.cheltuieli_extraordinare_view' table. You can move, or remove it, as needed.
            this.cheltuieli_extraordinare_viewTableAdapter.Fill(this.db_calculbugetDataSet11.cheltuieli_extraordinare_view);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("select sum(Suma+TVA) from cheltuieli_extraordinare;", SqlConn))
                {
                    SqlConn.Open();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConn.Open();
                SqlDataAdapter v1 = new SqlDataAdapter("cheltuieli_extraordinare_insert", SqlConn);
                ...
                v1.SelectCommand.Parameters.Add("@Tip_c", SqlDbType.VarChar, (50)).Value = textBox3.Text;
                try
                {
                    try
                    {
