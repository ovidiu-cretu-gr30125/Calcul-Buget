...
namespace Calcul_Buget
{
    public partial class Form8 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'db_calculbugetDataSet9.cheltuieli_de_exploatare_view' table. You can move, or remove it, as needed.
            this.cheltuieli_de_exploatare_viewTableAdapter.Fill(this.db_calculbugetDataSet9.cheltuieli_de_exploatare_view);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("select sum(Suma+TVA) from cheltuieli_de_exploatare;", SqlConn))
                {
                    SqlConn.Open();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConn.Open();
                SqlDataAdapter v1 = new SqlDataAdapter("cheltuieli_exploatare_insert", SqlConn);
